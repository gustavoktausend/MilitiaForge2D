...
- **[State Machine](components/state_machine.md)** - Generic state machine system ✅
  - State base class
...
- **[Movement System](components/movement.md)** - Movement component system ✅
  - MovementComponent base class
  - TopDownMovement implementation
  - Physics integration
  - Sprint system
  - Signal-based events

- **[Health System](components/health.md)** - Health and damage system ✅
  - HealthComponent
  - Hitbox and Hurtbox
...
- **[Input System](components/input.md)** - Input management system ✅
  - InputComponent
...
*Additional components will be documented as they are implemented*
